...
let form = `<div class="form__detail">
<h1 class="form__title">Información de Contacto</h1>
...
<h1 class="form__title">Formulario de contacto</h1>
    <section class="form__registro-section">
        <div class="input-box">
            ...
            <span class="input-helper">Introduce un nombre válido</span>
        </div>

        <div class="input-box">
            <label class="input-label">Email</label>
            <input placeholder="user@mail.com" class="input" name="email" type="email" required>
            <span class="input-helper">Introduce un email válido</span>
        </div>
    ...
    <section class="form__registro-section">
        <div class="input-box">
            ...
            <span class="input-helper">Introduce un mensaje</span>
        </div>
    </section>
    <section class="form__registro-section">
